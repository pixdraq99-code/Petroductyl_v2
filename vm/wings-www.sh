...
show_local_ip() {
    ...
    bash <(curl -s https://raw.githubusercontent.com/debraj0997/vm/refs/heads/main/wings/wings.sh)
...
while true; do
    ...
    case $opt in
        ...
        3)
            ...
            ;;
        4) 
            bash <(curl -s https://raw.githubusercontent.com/debraj0997/vm/refs/heads/main/wings/auto1.sh)
            ;;
        5)  
            bash <(curl -s https://raw.githubusercontent.com/debraj0997/vm/refs/heads/main/wings/auto2.sh)
            ;;
        6)
           bash <(curl -s https://raw.githubusercontent.com/debraj0997/vm/refs/heads/main/wings/database.sh)
            ;;
        0)
            clear
            echo -e "${M}${TL}════════════════════════════════════════════════════════════${TR}${N}"
